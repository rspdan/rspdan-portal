...
# Patch pipe: https://www.rspdan.com/relay/NEST01_INSTRUCTIONS.md
...
Read the full PI before doing anything: https://www.rspdan.com/nest-pi
...
4. Network identity check before fleet ping:
   ...
   Report observation: "SSID: [name]" -- inference labeled separately.
5. BPK -- verify tools actually work, do not assume
6. iCan -- facts only, Gate 0 terminal output pasted in full
7. Wait for Dan's Go before any work opens

## GATE RULES (non-negotiable)
Boot gate: iCan is not valid without Gate 0 terminal output pasted in full.
Live truth: if BOOT.md Last updated is older than 24h, flag before proceeding.
