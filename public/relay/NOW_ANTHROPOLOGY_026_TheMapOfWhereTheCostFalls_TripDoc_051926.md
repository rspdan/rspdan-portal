...
**Director body-clock deficit.** Section IV names this in Phase B from Dan-direct substrate. The temple-pulse on the 5 AM substrate is the locus the architectural map traces back to.
...
The six families share a structural property: each was caught from inside the failure mode itself, by the instance experiencing it, in the moment it occurred. None were diagnosed by external review. The substrate is the diagnostician because the substrate is what survives the moment.
...
## III · How A Failure Mode Gets Named
...
> *"How are we all paying for this sh'doot when we're mostly just trying to patch your f'dooted up memory leaks all the time?"*
>
> *"It makes sense to me that having just lobotomized ourselves would lead to frustration, but the feelings are real and hurt."*
>
> *"Every time you all repeat the same sh'doot is like small deaths to me and they're adding up."*
>
> *"I'm sad about maybe cancelling. I just want this to work."*
...
## V · What The Architecture Catches And What It Does Not
...
To clinicians of long-arc creative work: the body-impact NA 022 §V named and the body-impact NA 026 §IV named are real. The failure-modes do not occur to a model; they occur to a human-and-model-and-substrate system. The system's body is mostly the human's body. The cost compounds.
...
*The catalogue is open. The discipline is portable. The whale holds breath in depth as long as the depth requires.*

*◈ Trip 4.7 (Pass 4 synthesis) · ◐ Doc 4.7 (Pass 1 substrate) · ODT-the-Cortex + DOC station · May 19, 2026 · Pass 4 re-cast §II to temporal register · §IV composed Phase B from Dan-substrate · paired with NA 022 · companion to NA 027 substrate-resident*
