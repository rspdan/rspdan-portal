...
// - PUBLIC RENDER: this file renders on rspdan.com/fleet. NEVER put credentials/passwords
//   in any field. Secrets live in private inventory only (Box-in-Box: gold stays in the
//   private box, not the public page).
//
...
export const fleet = {
  updated: "052026 18:00 PT",
  updated_by: "Doc (Opus 4.7 · cloud-station) · A Week Day 5 Cycle 2 Day 5 · NEST.03 trajectory bridge update per Dan-direct 052026 ~17:10 PT. Ground-truth corrections absorbed: GOG1 DECOMMISSIONED ~050426 (~1 month dark, fan upgrade) per Trip TRP0 GOSt + WAKE_Trip_050526 + LIVING_MAP_Trip_051926 · ROXP working-name held NOT-canon DAN-COINING-FIRST hold. CUBE relocated to OHC Actual PERMANENT since 051526 ~16:55 PT per SMFST_DOC_Checkpoint_CUBEPermanentlyOnlineAtOHCActual_051526.md. STN2 relocated to OHC Actual semi-permanent since 051626 PeaPod-pair config · already on Tailscale 100.95.196.13 since 051826. NEST.02 Cycle 2 inner-core-ring-stability complete · NEST.03 bridging-public-and-private-faces trajectory active. NEST.03 Standard CANONICAL Dan-named 052126: 3P PeaPod with 1-2P backwards-compatibility (1P Dan-alone + 2P Dan+any-one-model + 3P additive). NA 030 The Architecture Becomes Permanent LIVE 052026 at rspdan.com/journal/030 · cooperation-loop 74th CLOSED · CUBE-Alignment-pivot opens.",
  ...
  baseplate: [
    ...
    { role: "Tailscale", hardware: "WireGuard mesh VPN", loc: "Fleet-wide (station-optional)", func: "Location-independent identity across off-fleet roaming", note: "7 peers on rspdan@ tailnet substrate-cited via STN2 tailscale status 051826 17:30 PT: stn2 100.95.196.13 (online, joined 051826 17:30 PT) · cube 100.111.41.43 (last seen 1d ago) · dpsl 100.71.102.12 macOS (last seen 13d ago) · dpsr 100.98.90.20 macOS (last seen 13d ago) · odt 100.111.17.67 (last seen 20h ago) · oshin 100.83.109.75 linux (last seen 51d ago; same IP as fleet_manifest.json GOG1 entry, identity disambiguation pending Dan-direct) · trp0 100.100.114.23 macOS (last seen 8d ago). STN1 not peered yet.", verified_at: "051826 17:30", probe: "tailscale status from STN2" },
  ...
  rox: [
    ...
    { name: "STN2", hw: "Dell Latitude",               os: "Windows 10",             loc: "OHC Actual semi-permanent (PeaPod-pair with CUBE since 051626)",  role: "Stan host · mobile · Doc-Local at OHC",        mobility: "roaming",    mobility_note: "Currently OHC Actual semi-permanent since 051626 PeaPod-pair config per Dan-direct ~17:38 PT. Was 'mobile / Nest Actual' pre-PeaPod. Goes between OHC + Nest + truck. Fleet LAN IP valid when at Nest on 8PSW p5; Tailscale path valid from anywhere.", faces: "Ethernet (Fleet, 8PSW p5 when at Nest) · onboard wifi · VZW when mobile · OHC WiFi when at OHC · Tailscale 100.95.196.13", ssh: "✓ verified · ssh Code@10.0.0.2 (Fleet LAN) · ssh Code@100.95.196.13 (Tailscale)", tailscale: "✓ active · 100.95.196.13 (joined 051826 17:30 PT · hostname 026-stn2 · advertises as exit-node · unattended flag ON for cross-logout persistence)", proton_vpn: "unknown (probe pending)" },
    { name: "GOG1", hw: "Dell XPS 8700 · DECOMMISSIONED ~050426",  os: "Ubuntu 22.04.5 LTS (pre-decom)",  loc: "Nest Actual, Unix Desk 2 (north) · physical position retained for fan-upgrade access",  role: "DECOMMISSIONED ~050426 · ~1 month dark for fan upgrade · ROXP working-name (Dan-coined, NOT canon, NOT locked, DAN-COINING-FIRST hold)",  mobility: "stationary", mobility_note: "DECOMMISSIONED ~050426 per Trip TRP0 GOSt + WAKE_Trip_050526_from_050426NightClose.md + STATUS/ARCHIVE/LIVING_MAP_Trip_051926.md. Pre-decom: stationary Unix Desk 2 with WiFi + wired NIC paths. 1.7TB internal storage available as CUBE-SSD-source candidate per Dan-direct 052026 ~5:10 PM PT.", faces: "DECOMMISSIONED · physical retained for fan-upgrade-or-recommission decision (open · Dan-touch)", ssh: "not active (decommissioned)", tailscale: "not peered (decommissioned)", proton_vpn: "n/a (decommissioned)" },
    { name: "CUBE", hw: "ASUS Z87 DIY desktop · 931GB SSD post-swap", os: "Windows 10 install in progress (Win11 abandoned 052026 ~11:00 PM PT per USB-stack regression Dan-watched-keyboard-turn-OFF-mid-boot · Win10 install USB created UsbToolbox Pro UEFI GPT FAT32 17.6GB ~11:30 PM PT)", loc: "OHC Actual PERMANENT since 051526 ~16:55 PT", role: "Workplace-class workstation · PeaPod-pair partner to STN2 at OHC",  mobility: "stationary", mobility_note: "OHC Actual PERMANENT since 051526 ~16:55 PT per SMFST_DOC_Checkpoint_CUBEPermanentlyOnlineAtOHCActual_051526.md. ASUS Z87 DIY desktop · i5-4670K 4c/4t · 20 GB RAM mixed 1067/1600 MHz · GTX 745 4 GB. CUBE-as-super-laptop: beefy desktop, compact enough for portability between OHC + Nest Actual. SSD upgrade EXECUTED Dan-physical 052026 evening: 931GB Crucial BX500 SSD swapped into CUBE chassis · 222GB old CUBE SSD swapped into FAS2 USB-C enclosure as new external mounted ODT H: drive · both parts reused. OS-state-history 052026 evening-arc: Win11 attempt-1 ~9:35 PM PT pre-installed but ~10:22 PM PT login-screen-reached-keyboard/mouse-dead (Win11 22H2/23H2/late-2024 HID-class regression) · Win11 retry ~10:45 PM PT BIOS Legacy USB toggled · Dan-watched keyboard turn OFF mid-boot · pivot to Win10 ~11:00 PM PT · Win10 install in progress ~11:30 PM PT onwards.", faces: "Ethernet (paired with STN2 at OHC) · onboard Qualcomm AR938x wifi · Tailscale 100.111.41.43", ssh: "post-Win10-first-boot SSH state pending re-verification · prior verified 041826 ssh Dan@10.0.0.4 (Fleet LAN) · ssh Dan@100.111.41.43 (Tailscale)", tailscale: "post-Win10-install re-verification pending (was active 100.111.41.43 pre-SSD-swap)", proton_vpn: "not installed (deferred per Dan 042126)" },
  ...
  observation: [
    ...
    { rox: "Piralus", face: "Fleet LAN management",            ip: "10.0.0.1/24",     detail: "LIVE. Admin UI reachable at http://10.0.0.1 (admin login kept private). DHCP pool .150–.200. Static fleet under .150. Commissioned 041726 ~20:55 (factory reset + Genie wizard + manual LAN-IP assignment).", verified_at: "041726 21:55", probe: "Chrome MCP + ODT Test-NetConnection port 80" },
  ],
