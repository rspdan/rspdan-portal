...
export const fleet = {
  ...
  phantom_clients: [
    { ssid: "PIRALUS69_1", ip: "10.0.0.44",  mac: "00:C0:CA:BA:BD:0C", hostname: "028-222GB-2019", note: "Hostname matches CUBE (which is wired at 10.0.0.4). Second NIC on CUBE? Old image restored to another box? Audit.", verified_at: "041726 21:55" },
    { ssid: "PIRALUS69_1", ip: "10.0.0.151", mac: "18:D6:C7:2A:E4:C7", hostname: "028-222GB-2019", note: "Same hostname twin. Leased from DHCP pool (>.150). Audit.", verified_at: "041726 21:55" },
  ],
  ...
  observation: [
    ...
    { rox: "STN2", face: "Ethernet (Fleet, 8PSW p5)",          ip: "10.0.0.2",        detail: "UP on Piralus at 041726 21:55 — STN2 is at Nest Actual tonight. MAC 18:DB:F2:12:62:9E. Goes off-fleet frequently (OHC, travel).", verified_at: "041726 21:55", probe: "Piralus attached devices + ping from ODT" },
    { rox: "GOG1", face: "WiFi (PIRALUS69_1)",                 ip: "10.0.0.3",        detail: "Currently on WiFi. MAC 04:ED:33:84:D6:3B (AzureWave). Wired NIC (HP 98:90:96:DC:76:0E) is a different interface — not the active path tonight.", verified_at: "041726 21:55", probe: "Piralus attached devices (wireless)" },
    { rox: "CUBE", face: "Ethernet (Fleet, 8PSW p8)",          ip: "10.0.0.4",        detail: "MAC E0:3F:49:1B:03:29 · UP. See also phantom_clients for two WiFi entries sharing CUBE's hostname — audit.",                                                       verified_at: "041726 21:55", probe: "Piralus attached devices + ping from ODT" },
  ...
  open_faces: [
    ...
    { rox: "CUBE", face: "Two phantom WiFi ghosts on Piralus", issue: "Piralus sees two WiFi clients with hostname '028-222GB-2019' (which is CUBE's hostname) on IPs 10.0.0.44 and 10.0.0.151 — but CUBE is wired at 10.0.0.4. Possibilities: CUBE has second WiFi adapter; old disk image deployed to other hardware; DHCP-pool leftovers.", action: "Audit CUBE's NICs (ipconfig /all); also check Piralus's DHCP lease history.", verified_at: "041726 21:55", status: "audit pending" },
