...
export const fleet = {
  ...
  hardware: {
    ...
    CUBE: {
      ...
      ram: "19.9 GB",
      gpu: "NVIDIA GeForce GT 730 · 2 GB VRAM · Kepler · driver 27.21.14.6647 (2020-21 era; weak, fits the MiniATX case — GTX 745 swap planned when Dan hits flow)",
      ...
      os: "Windows 10 Pro · build 18363 (version 1909, Nov 2019) — IN-PLACE UPGRADE TO 22H2 IN PROGRESS 041826 ~01:00 PT",
      install_date: "06/14/2020",
      net_adapters: [
        "onboard Realtek PCIe GbE · 10.0.0.4/24 (Fleet copper, 5PSW pN) · MAC E0:3F:49:1B:03:29 · canonical CUBE IP",
        "ALFA AWUS036ACH USB · Realtek 8812AU Wireless LAN 802.11ac · 10.0.0.44/24 (PIRALUS69_1 5GHz) · MAC 00:C0:CA:BA:BD:0C · dual-band 2.4/5 GHz · monitor-mode capable · 'likely the most powerful WiFi card in the Fleet' per Dan",
        "internal Qualcomm Atheros AR938x WiFi · currently 192.168.145.138 on unknown network (auto-joined — needs audit) · MAC 18:D6:C7:2A:E4:C7 · was briefly on PIRALUS69_1 earlier with stale DHCP lease 10.0.0.151 in Piralus attached_devices (not an active second Fleet IP — resolved 041826)",
      ...
      installed_software: {
        tailscale: "1.96.3 (installed 041826 ~00:55 PT · service Running · StartType Automatic · auth URL issued https://login.tailscale.com/a/a29e23f01d747 · pending Dan click)",
        claude_desktop: "BLOCKED until Win10 upgrade completes — installer log shows 'Claude requires Windows 10 version 2004 or later (build 19041+). Current build: 7600' (installer mis-detects as Win7 due to missing Win10 compat manifest; real gate is 19041+ which CUBE's 18363 doesn't meet)",
      ...
      verified_at: "041826 ~00:50 PT · full probe via passwordless admin SSH `dan@10.0.0.4` · matches Hardware List spreadsheet entry",
      probe: "cube_probe.ps1 + cube_claude_diag.ps1 + cube_tailscale_up.ps1 — all scp'd to C:\\Users\\Dan\\ on CUBE and run under Trip/ODT cycle",
    },
    DPSL: {
