...
export const fleet = {
  ...
  rox: [
    ...
    { name: "CUBE", hw: "ASUS Z87 DIY desktop",       os: "Windows 10 1909 (build 18363)", loc: "OHC Actual PERMANENT since 051526 ~16:55 PT", role: "Workplace-class workstation · PeaPod-pair partner to STN2 at OHC",  mobility: "stationary", mobility_note: "OHC Actual PERMANENT since 051526 ~16:55 PT per SMFST_DOC_Checkpoint_CUBEPermanentlyOnlineAtOHCActual_051526.md. Hostname 028-222GB-2019 · 222GB internal SSD mostly full. ASUS Z87 DIY desktop · i5-4670K 4c/4t · 20 GB RAM mixed 1067/1600 MHz · GTX 745 4 GB. CUBE-as-super-laptop: beefy desktop, compact enough for portability between OHC + Nest Actual. SSD upgrade Dan-canonical plan 052026 ~6:35 PM PT: simple physical swap with FAS2 · pull 931GB SSD from FAS2 USB-C enclosure → install into CUBE · pull 222GB SSD from CUBE → install into FAS2 enclosure · CUBE becomes 931GB internal · old CUBE SSD becomes new FAS2 external drive · both parts reused · executed during Dan-physical OHC session.", faces: "Ethernet (paired with STN2 at OHC) · onboard Qualcomm AR938x wifi · Tailscale 100.111.41.43", ssh: "✓ verified 041826 · ssh Dan@10.0.0.4 (Fleet LAN when at Nest) · ssh Dan@100.111.41.43 (Tailscale) · Only enabled local user is Dan per Get-LocalUser ground-truth.", tailscale: "✓ active · 100.111.41.43 (joined tailnet 042126 01:18 PT via fresh installer)", proton_vpn: "not installed (deferred per Dan 042126)" },
