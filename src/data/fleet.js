...
export const fleet = {
  ...
  rox: [
    ...
    { name: "CUBE", hw: "ASUS Z87 DIY desktop",       os: "Windows 10 1909 (build 18363)", loc: "Nest Actual, near closet",            role: "Tertiary workstation",                      mobility: "stationary", mobility_note: "Stationary near closet. Hostname 028-222GB-2019 (ground-truthed 041926 via SSH probe). ASUS Z87 DIY desktop (NOT HP EliteDesk Mini as prior canon stated — corrected 041926). i5-4670K 4c/4t, 20 GB RAM mixed 1067/1600 MHz, GTX 745 4 GB.", faces: "Ethernet (Fleet, 8PSW p8) · onboard Qualcomm AR938x wifi · second wifi (internal) briefly caught PIRALUS69_1 stale lease", ssh: "✓ verified 041826 · ssh Dan@10.0.0.4 · NOT Code (prior symmetry-assumption canon was wrong, corrected via Get-LocalUser). Only enabled local user is Dan. Key in C:\\ProgramData\\ssh\\administrators_authorized_keys (admin-group path). See RELAY/STANDARD_RULE_GetLocalUserIsGroundTruth_Trip_041826.md.", tailscale: "✓ active · 100.111.41.43 (joined tailnet 042126 01:18 PT via fresh installer — four-day NoState wedge cleared)", proton_vpn: "not installed (deferred to library trip per Dan 042126)" },
