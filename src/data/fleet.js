...
export const fleet = {
  ...
  hardware: {
    ...
    CUBE: {
      cpu: "probe-pending",
      ram: "probe-pending",
      gpu: "probe-pending (integrated expected)",
      storage: "probe-pending",
      net_adapters: [
        "onboard ethernet · 10.0.0.4/24 (Fleet, 8PSW p8) · MAC E0:3F:49:1B:03:29",
        "internal PCIe WiFi (probe-pending)",
        "ALFA AWUS036ACH · USB-C · 10.0.0.44 MAC 00:C0:CA:BA:BD:0C · Realtek RTL8812AU · dual-band 2.4/5GHz · monitor-mode capable · per Dan 'likely the most powerful WiFi card in the Fleet now'",
      ],
      known_blocker: "Claude Desktop install blocked by some Windows Update requirement Dan couldn't resolve — 'a crazier Catch-69 than Piralus.' Needs investigation before CUBE can join Claude-capable stations.",
      user: "Code (SAME USERNAME AS STN2 — always hostname-verify before SSH)",
      verified_at: "spec-probe-pending",
      probe: "needs probe pass once Claude or SSH access is established on CUBE",
    },
    DPSL: {
