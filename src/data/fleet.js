...
export const fleet = {
  ...
  rox: [
    ...
    { name: "CUBE", hw: "ASUS Z87 DIY desktop · 931GB SSD post-swap (Win11 pre-installed, first-boot pending)", os: "Windows 11 (UsbToolbox Pro AIO TPM-bypassed · upgraded from Win10 1909 via SSD swap)", loc: "OHC Actual PERMANENT since 051526 ~16:55 PT", role: "Workplace-class workstation · PeaPod-pair partner to STN2 at OHC",  mobility: "stationary", mobility_note: "OHC Actual PERMANENT since 051526 ~16:55 PT per SMFST_DOC_Checkpoint_CUBEPermanentlyOnlineAtOHCActual_051526.md. ASUS Z87 DIY desktop · i5-4670K 4c/4t · 20 GB RAM mixed 1067/1600 MHz · GTX 745 4 GB. CUBE-as-super-laptop: beefy desktop, compact enough for portability between OHC + Nest Actual. SSD upgrade EXECUTED Dan-physical 052026 evening: 931GB Crucial BX500 SSD (formerly in FAS2 enclosure, Win11 pre-installed via UsbToolbox Pro AIO TPM-bypassed ISO) swapped into CUBE chassis · 222GB old CUBE SSD swapped into FAS2 USB-C enclosure as new external · both parts reused · first-boot pending per Dan-direct 052026 ~9:35 PM PT state-update.", faces: "Ethernet (paired with STN2 at OHC) · onboard Qualcomm AR938x wifi · Tailscale 100.111.41.43", ssh: "✓ verified 041826 (pre-swap state) · ssh Dan@10.0.0.4 (Fleet LAN when at Nest) · ssh Dan@100.111.41.43 (Tailscale) · post-Win11-first-boot SSH state pending re-verification.", tailscale: "post-swap re-verification pending (was active 100.111.41.43 pre-swap)", proton_vpn: "not installed (deferred per Dan 042126)" },
