...
export const fleet = {
  ...
  hardware: {
    ...
    CUBE: {
      ...
      installed_software: {
        tailscale: "1.96.3 · service Running · StartType Automatic · BackendState=NoState (auth URL was issued 041826 https://login.tailscale.com/a/a29e23f01d747, Dan click still pending 042126) — FOUR DAYS PENDING, LONGWEIRD INDICATOR",
        ...
        claude_code_cli: "NOT INSTALLED (as of 042126 probe) · node/npm also NOT INSTALLED — both must be installed before Claude Code CLI test; HEREGULL pending whether Claude Code works on 1909 at all",
      ...
      verified_at: "042126 00:10 PT · full probe via ssh Dan@10.0.0.4 running probe_cube_042126.ps1 (scp'd to C:\\Users\\Dan\\) · reconciled against 041826 Trip-CUBE Graft (Gmail thread id 19da3359845aba21, subject CUBE hardware probe — GTX 745 swap) whose fleet.js update instructions were dropped by 041826 ODT-Trip and are now executed here · partial prior verify 041826 ~00:50 PT",
