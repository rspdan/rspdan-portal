...
export const fleet = {
  ...
  baseplate: [
    ...
    { role: "Tailscale", hardware: "WireGuard mesh VPN", loc: "Fleet-wide (station-optional)", func: "Location-independent identity across off-fleet roaming", note: "ODT active at 100.111.17.67 and CUBE active at 100.111.41.43 (joined 042126 01:18 PT). STN2/TRP0/STN1 join when off-fleet. DPSL/DPSR + GOG1 not peered yet.", verified_at: "042126 01:18", probe: "tailscale status" },
